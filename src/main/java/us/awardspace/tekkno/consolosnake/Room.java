package us.awardspace.tekkno.consolosnake;
...
import us.awardspace.tekkno.consolosnake.observer.KeyboardObserver;
import us.awardspace.tekkno.consolosnake.subjects.Mouse;
import us.awardspace.tekkno.consolosnake.subjects.Snake;
...
public class Room {
    ...
    /**
     * The length of the pause depends on the length of the snake.
     */
    public void sleep() {
        try {
